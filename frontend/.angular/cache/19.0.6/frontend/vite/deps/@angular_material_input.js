import {
  ...
  MatPrefix,
  MatSuffix
} from "./chunk-RIFAUITV.js";
import {
  FormGroupDirective,
  NgControl,
  NgForm,
  Validators
} from "./chunk-GBFA2C5G.js";
import "./chunk-6GTRD6EI.js";
import {
  ErrorStateMatcher,
  MatCommonModule,
  Platform,
...
} from "./chunk-BCD33OTK.js";
import {
  DOCUMENT
} from "./chunk-7TP74Q67.js";
import {
  ...
  ngAfterViewInit() {
    if (this._platform.isBrowser) {
      ...
      this._ngZone.runOutsideAngular(() => {
        ...
        this._listenerCleanups = [this._renderer.listen(this._textareaElement, "focus", this._handleFocusEvent), this._renderer.listen(this._textareaElement, "blur", this._handleFocusEvent)];
      });
